      ...
      <section id="home-hero" className="relative w-full pt-20 md:pt-24 pb-8 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto min-h-[50vh] lg:min-h-[50vh] flex flex-col justify-center">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-5/12 order-2 lg:order-1 flex flex-col justify-center z-10">
            <div className="hero-eyebrow w-fit flex items-center justify-center gap-1.5 md:gap-2 mb-6 px-4 py-2 rounded-[22px] bg-gradient-to-r from-slate-50 to-slate-100 border border-slate-200">
              ...
              <span className="text-[11px] md:text-xs font-medium text-slate-700 ml-1">Perfect 5.0 Rating</span>
            </div>
